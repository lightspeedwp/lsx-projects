...
class LSX_Project_Settings
{
    ...
    {
        add_options_page('Bootstrap Project Options', 'Bootstrap Project', 'manage_options', 'project_options',
        ...
        <div class="wrap">
            ...
            <form method="post" action="options.php">
                ...
                <table class="form-table">
                    <tr valign="top">
                        <th scope="row">Disable Single Posts</th>
                        <td>
                            <input name="project_options[disable_single]" type="checkbox" value="1" <?php checked('1',
                                $options['disable_single']); ?> />
                        </td>
                    </tr>
                    <tr valign="top">
                        <th scope="row">Show groups</th>
                        <td>
                            <input name="project_options[show_groups]" type="checkbox" value="1" <?php checked('1',
                                $options['show_groups']); ?> />
                        </td>
                    </tr>
                    <tr valign="top">
                    ...
                    <tr valign="top">
                        ...
                        <td>
                            <label for="upload_image">
                                ...
                                ?>
                                <input id="upload_image" type="text" size="36" name="project_options[placeholder]"
                                       value="<?php echo $options['placeholder']; ?>"/>
