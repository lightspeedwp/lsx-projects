...
class BS_Project_Widget extends WP_Widget {
    ...
    function form($instance) {  
        ...
        <p>
            <label for="<?php echo $this->get_field_id('title_link'); ?>"><?php _e( 'Title Link:', 'bs-project' ); ?></label> 
        ...
        <p>
            <label for="<?php echo $this->get_field_id('limit'); ?>"><?php _e( 'Maximum amount:', 'bs-project' ); ?></label>
            <input class="widefat" id="<?php echo $this->get_field_id('limit'); ?>" name="<?php echo $this->get_field_name('limit'); ?>" type="text" value="<?php echo $limit; ?>" />
            <small><?php _e('Leave empty to display all'); ?></small>
        </p>       
        <p class="bs-projects-specify">
            <label for="<?php echo $this->get_field_id('include'); ?>"><?php _e( 'Specify Project s by ID:', 'bs-project' ); ?></label>
