...
Show off your finest work with the LSX Projects Extension! It adds a “Projects” post type, allowing you to categorize and display your Projects on your LSX website.

== Description ==
LightSpeed’s LSX Projects Extension plugin is here to help you add advanced “Projects” section options to your Wordpress site running LSX Theme.
...
Users will also find that LSX Projects works with Woocommerce, allowing you to conect products with projects, with the help of the [theme](https://www.lsdev.biz/product/lsx-wordpress-theme/).
...
Bugs can be reported either in our support account or preferably on the LSX Projects [GitHub repository](https://github.com/lightspeeddevelopment/lsx-projects).
